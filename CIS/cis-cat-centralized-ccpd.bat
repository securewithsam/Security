...
SET NetworkShare=\\sws-infcis-01.changeme.corp\CIS\

::
:: Path to debug log when DEBUG=1
::

SET DebugLogFile=\\sws-infcis-01.changeme.corp\CIS\cis-cat-debug-log.txt
...
SET CCPDUrl=https://sws-infcis-01.changeme.corp/CCPD/api/reports/upload
...
SET CISCAT_OPTS=-html -ui

::
:: Configure the Authentication Token generated for an "API" user in CIS-CAT Pro Dashboard
::
SET AUTHENTICATION_TOKEN=f81a74878lkjlk45-this-is-test-api-30d0d8
...
ECHO.
ECHO Centralized CIS-CAT Wrapper including CIS-CAT Pro Dashboard
...
SET Benchmark=CIS_Microsoft_Windows_Server_2019_Benchmark_v3.0.0-xccdf.xml
...
:ERROR_JAVA_PATH
ECHO Critical Error: The directory %JavaPath% does not exist.
